          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                <a href="mailto:anoopsingla21@gmail.com">
              ...
              <div className="flex items-start space-x-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                <a href="tel:+917973615582"> <div className="flex-shrink-0 w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                  <FaPhone className="text-green-600 text-xl" />
                </div>
                </a>
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Phone</h4>
                  <p className="text-gray-600">+91 79736-15582</p>
              ...
              <div className="flex items-start space-x-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                <a
                  href="https://www.google.com/maps/place/30°12'19.5%22N+74°39'34.1%22E"
                  target="_blank"
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onBlur={handleBlur}
                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 ${hasError('name')
                  ...
                  <div className="flex justify-between mt-1">
                    ...
                    <span className={`text-xs ml-auto ${formData.name.length > 45 ? 'text-red-600' : 'text-gray-500'
                      }`}>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 ${hasError('email')
                        ? 'border-red-300 focus:ring-red-500'
                        : 'border-gray-300 focus:ring-blue-500'
                      }`}
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 ${hasError('subject')
                      ? 'border-red-300 focus:ring-red-500'
                      : 'border-gray-300 focus:ring-blue-500'
                    }`}
                ...
                <div className="flex justify-between mt-1">
                  ...
                  <span className={`text-xs ml-auto ${formData.subject.length > 180 ? 'text-red-600' : 'text-gray-500'
                    }`}>
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 resize-vertical ${hasError('message')
                      ? 'border-red-300 focus:ring-red-500'
                      : 'border-gray-300 focus:ring-blue-500'
                    }`}
                ...
                <div className="flex justify-between mt-1">
                  ...
                  <span className={`text-xs ml-auto ${formData.message.length > 1800 ? 'text-red-600' : 'text-gray-500'
                    }`}>
